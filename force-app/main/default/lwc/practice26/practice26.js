...
export default class Practice26 extends LightningElement {
    ...
    // according to recordId get the entire opp record and wire into below property
    // salesforce provide set of javascript method to get single data
    ...
    // easier way to get vthe filed value out of the wire result from getRecord method is
    ...
    // Create a getter to get string version opp property above
    get oppInString(){
